...
class GeoCLIP(nn.Module):
    def __init__(self,  input_resolution=224, opt=None, dim=512, gps_gallary_path="gps_gallery_100K.csv"):
        super().__init__()
        ...
        self.gps_gallery = load_gps_data(gps_gallary_path)

        # Load weights
        self.logit_scale = nn.Parameter(torch.load(PAR_DIR/"weights/logit_scale_weights.pth"))
        self.location_encoder.load_state_dict(torch.load(PAR_DIR/"weights/location_encoder_weights.pth"))
